...
class CariBeritaUser extends StatefulWidget {
  final int selectedIndex;

  const CariBeritaUser({super.key, this.selectedIndex = 1});

  @override
  State<CariBeritaUser> createState() => _CariBeritaUserState();
}

class _CariBeritaUserState extends State<CariBeritaUser> {
  ...
  Future<void> _onItemTapped(BuildContext context, int index) async {
    ...
    if (index == 2) {
      await Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (context) => const RiwayatBacaUser(selectedIndex: 2),
        ),
      );
    }
  }
